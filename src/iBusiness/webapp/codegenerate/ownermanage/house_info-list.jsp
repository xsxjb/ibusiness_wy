...
<html>
  ...
  <head>
    ...
    <script type="text/javascript">
		var config = {
			...
			gridFormId: 'gridForm',
	        exportUrl: 'house_info-export.do'
		};
  ...
  <body>
	...
	<!-- 查询条件 -->
	   ...
	   <div class="panel-heading"><h4 class="panel-title">楼栋信息表列表</h4></div>
       <div class="panel-body">
		    <div class="pull-left">
			    <button class="btn btn-default btn-sm a-insert" onclick="location.href='house_info-input.do'">新建</button>
	   ...
	   <div class="content">
			<form id="gridForm" name="gridForm" method='post' action="house_info-remove.do" class="m-form-blank">

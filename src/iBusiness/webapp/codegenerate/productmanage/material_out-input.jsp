...
<html>
  ...
  <body>
	...
	<div class="panel panel-default col-md-10"> 
	    <div class="panel-heading"><h4 class="panel-title">(领料)物料出库信息流程控制</h4></div>
		       ...
		       <form id="mainForm" method="post" action="material_out-complete.do" class="form-horizontal">
				   ...
				   <c:if test="${model != null}">
				       ...
				       <input type="hidden" name="doneflag" value="${model.doneflag}">
						 ...
						 <div class="form-group">
						           <label class="control-label  col-lg-2" for="code-productno">用途说明:</label>
                              <!-- 编辑类型     多行 --><div class="col-lg-6">  <c:if test="${nodeColumsMap.productno.fcEdit=='1'}">    <textarea class="form-control" id="code-productno" name="productno" rows="1" >${model.productno}</textarea>  </c:if>  <c:if test="${nodeColumsMap.productno.fcEdit!='1'}">    <label>${model.productno}</label>    <input type="hidden" name="productno" value="${model.productno}">  </c:if></div>
